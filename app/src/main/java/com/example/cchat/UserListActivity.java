...
public class UserListActivity extends AppCompatActivity {
    ...
    private void attachUserDBReference() {
        ...
        if(userChilEventListener==null){
            userChilEventListener=new ChildEventListener() {
                @Override
            ...
            userDatabaseReference.addChildEventListener(userChilEventListener);
        }
    ...
    private void goToChat(int position) {
        Intent intent=new Intent(UserListActivity.this, CChatActivity.class);
